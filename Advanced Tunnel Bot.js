/* 
ADVANCED TUNNEL BOT V2
    By yodabird19 edited by Sublime
...
// PATTERN TO MINE
const feetplus3 = "XXXXXXXXX"
const feetplus2 = "XXXOOOOXX"
const feetplus1 = "XXXOOOOXX"
const feetplus0 = "XXXOOOOXX"
//  player stands here ^
...
const orientation = "south" // any direction you want to dig in
...
"minecraft:dripstone_block","minecraft:raw_gold","minecraft:netherack","minecraft:raw_iron","minecraft:redstone","minecraft:lapis_lazuli"]

// The number of layers of tunnel the bot should mine before terminating.
const layersToMine = 5000
...
function toolSwitch(){ //Function to switch to the lowest durability axe still usable
    ...
    const pickaxe = inv.getSlot(36);
    const enchantHelper = pickaxe.getEnchantment("Efficiency");
