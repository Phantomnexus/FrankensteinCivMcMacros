...
V2.1 - Reverted equipTool() to original, less robust code (may cause null error).
       Compactor Deactivation Fix Applied: Increased wait times in compact().

V1.4 - Updated for W key tapping logic.
